    ...
    if($oldPass != '' && $newPass != '' && $confirmPass != ''){
        if($oldPass == $result['password']){
            if($newPass === $confirmPass){
                $sql = "UPDATE teacher SET password='$newPass' WHERE teacher_id='$id'";
                $query = $con->query($sql);
                            ...
                            <div class="form-group">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            <th>New Password</th>
                                            <td><input type="password" class="form-control" name="newpass" id="newpass" pattern=".{6,}" placeholder="Enter new password"></td>
                                        </tr>
                                        <tr>
