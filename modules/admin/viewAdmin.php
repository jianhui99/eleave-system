...
if(isset($_POST['delete'])){
    ...
    if(mysqli_affected_rows($con) > 0){
        $_SESSION['message'] = "Admin Record has been deleted success.";
...
<div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="page-header">Current Admin Records</h2>
                        </div>
                    </div>
                    <!-- title -->
                    <!-- bootstrap alert -->
                                    ...
                                    <form method="post">
                                        <div class="form-group">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped" id="dataTables_admin">
                                                    ...
                                                    <tbody id="myTable">
                                                        <?php
                                                            ...
                                                            while($row = mysqli_fetch_array($query)){
                                                                ...
                                                                echo "<td><a href='addAdmin.php?editid=$id' class='btn btn-info'>Edit</a>
